...
class SVCDetector(Evaluator):
    """ Logistic Detection Evaluator that leverages SDMetrics Detection with Support Vector Classifier
    ...
    def compute_result(self):
        ...
        result = SVCDetection.compute_breakdown(
