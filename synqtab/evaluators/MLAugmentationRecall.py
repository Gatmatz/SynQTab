...
class MLAugmentationRecall(DualEvaluator):
    def __init__(self, target_label:str, positive_class:str, notes:bool = False):
        self.notes = notes
...
if __name__ == "__main__":
    ...
    evaluator = MLAugmentationRecall(prior_info['target_feature'], 1, notes=True)
