...
class MLAugmentationRecall(Evaluator):
    """ ML Augmentation Classifier Recall Efficacy Evaluator. Leverages
    https://docs.sdv.dev/sdmetrics/roi-metrics/ml-augmentation/binaryclassifierrecallefficacy. Parameters:
