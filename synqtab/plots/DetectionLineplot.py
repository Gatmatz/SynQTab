...
class DetectionLineplot(Plot):
    def __init__(self, params: dict):
        super().__init__(params)
    
    def read_data(self):
        df_lines = PostgresClient.lineplot_query(f'{self.params.get("metric", "QLT")}#R#SH')
...
if __name__ == '__main__':
    params = {'title': "SVD_lineplot_grid", 'metric': 'SVD'}
    DetectionLineplot(params).run()